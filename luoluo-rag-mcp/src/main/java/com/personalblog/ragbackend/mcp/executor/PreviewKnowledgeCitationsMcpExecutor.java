...
@Component
public class PreviewKnowledgeCitationsMcpExecutor {

    private static final String TOOL_ID = "previewKnowledgeCitations";

    private final RagMcpTools ragMcpTools;

    public PreviewKnowledgeCitationsMcpExecutor(RagMcpTools ragMcpTools) {
        this.ragMcpTools = ragMcpTools;
    }

    @Bean
    public McpServerFeatures.SyncToolSpecification previewKnowledgeCitationsToolSpecification() {
    ...
    private Tool buildTool() {
        ...
        properties.put("query", Map.of("type", "string", "description", "检索问题"));
        properties.put("topK", Map.of("type", "integer", "description", "候选数量，范围 1 到 20，默认 5"));
        ...
        return Tool.builder()
                .name(TOOL_ID)
                .description("查看当前问题命中的候选知识片段，便于人工核对召回质量")
    ...
    private CallToolResult handleCall(CallToolRequest request) {
        ...
        try {
            ...
            String result = ragMcpTools.previewKnowledgeCitations(
