package com.personalblog.ragbackend.knowledge.aop;
...
import com.personalblog.ragbackend.knowledge.service.rag.RagTraceRecordService;
...
public class ChatRateLimitAspect {
    ...
    @Around("@annotation(com.personalblog.ragbackend.knowledge.aop.ChatRateLimit)")
